...
def comparar_patrones(patron1, patron2):
    ...
    """
    x1,y1 = interpolar_muestra(patron1)
    x2,y2 = interpolar_muestra(patron2)
    correlacion = calcular_correlacion(y1,y2)
    #print("Extra: ",calcular_correlacion(np.array(patron1), np.array(patron2)))
    '''
